...
export const games = {
  en: {
    ...
    "invention.problemLabel": "Problem:",
    "invention.presentingIntro": "Presenting",
    "invention.youPresenting": "You are presenting",
    "invention.watchPresenting": "Watch {name} invention",
    ...
    "invention.remaining": "{amount} left",
  ...
  "pt-BR": {
    ...
    "invention.problemLabel": "Problema:",
    "invention.presentingIntro": "Apresentando",
    "invention.youPresenting": "Você está apresentando",
    "invention.watchPresenting": "Veja a invenção de {name}",
    ...
    "invention.remaining": "{amount} restante",
